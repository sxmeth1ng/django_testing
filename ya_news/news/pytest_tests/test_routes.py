...
def test_comment_not_availability_for_anonymous_user(client, name, id_for_args):
    url = reverse(name, args=id_for_args)
    response = client.get(url)
...
def test_comment_availability_for_not_author(not_author_client, name, id_for_args):
    url = reverse(name, args=(id_for_args))
